...
def test_main_page():
    """
    In this function, we make sure the homepage has been corretly deployed
    """
    response = client.get("/")
...
def test_decision():
    """
    In this function, we test the decision function which takes 
    an image and coordinates of the detected box as inputs. It returns the
...
def test_download():
    """
    In this function, we download the result after generating it with 
